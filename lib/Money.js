...
class Money {
  ...
  static getLocale(locale) {
    if (_.isPlainObject(Money.LOCALES[locale]) || _.isPlainObject(Money.LOCALES[locale.toLowerCase()])) {
      return Money.LOCALES[locale] || Money.LOCALES[locale.toLowerCase()];
    } else if (_.isPlainObject(Money.CURRENCIES[locale]) || _.isPlainObject(Money.CURRENCIES[locale.toLowerCase()])) {
      return Money.CURRENCIES[locale] || Money.CURRENCIES[locale.toLocaleLowerCase()];
    }
